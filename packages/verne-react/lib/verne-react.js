(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("verne-react", [], factory);
	else if(typeof exports === 'object')
		exports["verne-react"] = factory();
	else
		root["verne-react"] = factory();
...
class Inline extends React.Component {
    ...
    render() {
        if (config_1.debug.log.docRendering) {
        ...
        return this.props.node.attrs
            ...
            .reduce((Prev, Cur) => React.createElement(Cur, null, Prev), React.createElement(text_1.default, { node: this.props.node }));
    }
}
Inline.attrElMap = {
    bold: 'strong',
...
class Selection {
    static getUserSelection() {
        ...
        const anchorNode = node_map_1.default.getTextNode(nativeSelection.anchorNode);
        const focusNode = node_map_1.default.getTextNode(nativeSelection.focusNode);
        const anchorOffset = nativeSelection.anchorOffset;
        const focusOffset = nativeSelection.focusOffset;
        return new Selection(anchorNode, focusNode, anchorOffset, focusOffset);
    }
    static setCaret(node, offset) {
        const domNode = node_map_1.default.getDomNode(node);
        const nativeSelection = window.getSelection();
...
class Text extends React.Component {
    ...
    componentDidMount() {
        node_map_1.default.set(ReactDOM.findDOMNode(this), this.props.node);
    }
    shouldComponentUpdate(nextProps) {
        return nextProps.node.id !== this.props.node.id;
    }
    componentWillUnmount() {
        node_map_1.default.delete(ReactDOM.findDOMNode(this));
    }
    componentDidUpdate() {
        node_map_1.default.delete(this.domNode);
        node_map_1.default.set(ReactDOM.findDOMNode(this), this.props.node);
    }
    render() {
        if (config_1.debug.log.docRendering) {
...
function handleBeforeInput(editor, e) {
    return __awaiter(this, void 0, void 0, function* () {
        e.preventDefault();
        const selectionJson = selection_1.default.getUserSelection().toJson();
        ...
        editor.setState(() => ({ doc }));
        if (selection)
            selection_1.default.setCaret(selection.focusNode, selection.focusOffset);
    });
}
...
//# sourceMappingURL=verne-react.js.map